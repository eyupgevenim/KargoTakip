...
public class pnlAylikRaporlamaGM extends JPanel {
	...
	public pnlAylikRaporlamaGM() {
		...
		btn_aListele.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ArrayList<Kargo> gL= new Kargo().subelerAylik(tarih);
				if(gL != null){
					for(Kargo k:gL){
						Object[] row = {
		...
		dcTarih.setBounds(10, 22, 158, 31);
		panel.add(dcTarih);
		...
		dm.setColumnIdentifiers(new String[] {
				"Þube Adý", "Kargo Sayýsý", "Toplam Ücret"
			});
		table.setModel(dm);
