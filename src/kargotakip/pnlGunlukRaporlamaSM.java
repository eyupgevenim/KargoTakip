...
public class pnlGunlukRaporlamaSM extends JPanel {
	...
	public pnlGunlukRaporlamaSM() {
		...
		btn_aListele.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ArrayList<Kargo> gL= new Kargo().subeGunluk(frmMain.SUBE_,tarih);
				
				if(gL != null){
					for(Kargo k:gL){
						Object[] row = {
								k._gondericiPersonel.adi+" "+k._gondericiPersonel.soyadi,k.kilo,k.desi,k.ucret
							};
						dm.addRow(row);
					}
